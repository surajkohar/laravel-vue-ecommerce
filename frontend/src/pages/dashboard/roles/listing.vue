  ...
  <div class="products-listing">
    <div class="header-section">
      ...
      <div class="action-buttons">
        <button class="add-button" @click="router.push('/admin/role/add')">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
      ...
      <div class="search-container">
        <input type="text" v-model="filters.search" @input="fetchRoles" placeholder="Search roles..." class="search-input">
      </div>
    </div>
        ...
        <tbody>
          <tr v-for="role in roles.data" :key="role.id">
            ...
            <td class="actions-cell">
              <button class="edit-button" @click="editRole(role.id)">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
const fetchRoles = async () => {
  try {
    ...
    const response = await fetch(`${API.BACKEND_URL}/roles?${queryParams.toString()}`, {
      method: 'GET',
      headers: {
