    ...
    <nav>
      ...
      <div class="dropdown-wrapper">
        ...
        <div class="dropdown-content" :class="{ show: showProductsDropdown }">
          <RouterLink to="/admin/products" class="dropdown-item" @click="handleLinkClick" :class="{ active: isActive('/admin/products') || isActive('/admin/product/add') || isActive('/admin/product/' + $route.params.id + '/view') ||
      ...
      <RouterLink  to="/admin/email-templates" @click="handleLinkClick"
        :class="{ active: isActive('/admin/email-templates') }">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
