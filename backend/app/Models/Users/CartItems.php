...
class CartItems extends AppModel
{
    ...
    * @param $limit
    */
    public static function getAll($select = [], $where = [], $orderBy = 'CartItems.id desc', $limit = null)
    {
    	$listing = CartItems::orderByRaw($orderBy);
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'cart_items.id desc')
    {
    	$record = CartItems::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return CartItems::whereIn('cart_items.id', $ids)
		    		->update($data);
	    }
	    else
	    {
