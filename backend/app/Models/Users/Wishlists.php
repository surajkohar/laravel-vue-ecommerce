...
class Wishlists extends AppModel
{
    ...
    */
    ...
    {
    	$orderBy = $request->get('sort') ? $request->get('sort') : 'carts.id';
    	$direction = $request->get('direction') ? $request->get('direction') : 'desc';
    	$page = $request->get('page') ? $request->get('page') : 1;
    	$limit = self::$paginationLimit;
    	$offset = ($page - 1) * $limit;

        $listing = Wishlists::select([
            'wishlist.*',
            'owner.first_name as owner_first_name',
            'owner.last_name as owner_last_name'
        ])
        ->leftJoin('admins as owner', 'owner.id', '=', 'wishlist.created_by')
    ...
    * @param $limit
    */
    public static function getAll($select = [], $where = [], $orderBy = 'Carts.id desc', $limit = null)
    {
    	$listing = Carts::orderByRaw($orderBy);
    ...
    * @param $orderBy
    */
    public static function getRow($where = [], $orderBy = 'carts.id desc')
    {
    	$record = Carts::orderByRaw($orderBy);
    ...
    */
    public static function modifyAll($ids, $data)
    {
    	if(!empty($ids))
    	{
    		return Wishlists::whereIn('wishlist.id', $ids)
		    		->update($data);
	    }
	    else
	    {
